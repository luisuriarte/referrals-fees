	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				$insert = mysqli_query($con, "INSERT INTO fees(pid, fee_date, fee, discount, method, billing_period, month_type, user_auth, inserted_at, deleted) VALUES('$p_id', '$timestamp', '$fee', '$discount', '$method', '$billing_period', '$month_type', '$user','$timestamp', '0')") or die(mysqli_error());
				if($insert){
